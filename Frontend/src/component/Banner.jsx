...
export default function Banner() {
  return (
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row items-center my-10">
      ...
      <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32 order-2 md:order-1 space-y-8">
        <h1 className="text-4xl font-bold">
          Hello, welcome hero to learn something{" "}
          <span className="text-pink-500">new every day!!!</span>
        </h1>
        <p className="text-xl">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, at
          totam, tempora amet atque expedita quae corrupti sed pariatur corporis
      ...
      <div className="order-1 md:order-2 w-full md:w-1/2 flex justify-center">
        <img src={banner} className="w-[300px] h-[300px] object-cover" alt="Banner" />
      </div>
    </div>
  );
}
